...
conn = sqlalchemy.create_engine("mysql+pymysql://hr:123@localhost/hh").connect()

import pandas as pd


# Загружаем наименования вакансий
sql = 'select name from hh.vacancies'
...
display.display_html(html)  # Отображаем в ячейке ранее подготовленный html c js-функцией
