...
eng = sql.create_engine("mysql+pymysql://hr:123@localhost/hh")
#eng = mysql.connector.connect(user='hr', password='123', host='127.0.0.1', database='hh')
#sql.create_engine('postgresql://{Пользователь}:{Пароль}@{Сервер}:{Port}/{База данных}')
conn = eng.connect()
